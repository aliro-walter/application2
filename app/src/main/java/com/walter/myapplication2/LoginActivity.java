...
import com.walter.myapplication2.UserDBHelper; // ✅ Import your DBHelper if it’s in a subfolder (adjust path)
import com.walter.myapplication2.User; // ✅ Import your User model if it exists (adjust path)
